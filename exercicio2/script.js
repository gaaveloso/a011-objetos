...
console.log("O nome do ultimo ator/atriz é:",filme.elenco[filme.elenco.length-1])

//c) Qual o código para exibir o array com **todas** as transmissões de hoje?
console.log("As transmissões de hoje:",filme.transmissoesHoje)

//d) Qual o código para exibir o **horário** de transmissão do filme no `Canal Brasil`?
console.log("No Canal Brasil vai passar as",filme.transmissoesHoje[1].horario)